...
volatile _Bool SW3_Released = 1 ;
volatile _Bool LED_Shift = 1 ;
volatile _Bool SW_Detected = 0 ;
...
int main(void)
{
    ...
    (INTCON0bits.GIE = 1);
        ...
        OLED_Put8x16Str(0,6,"                ");
                ...
                I2C_Wbuffer[0] = 0xd0 ;
                I2C1_Host.WriteRead(0x76,I2C_Wbuffer,1,I2C_Rbuffer,1);
            ...
            I2C_Wbuffer[1] = 0x00 ;
            I2C_Wbuffer[2] = 0x18 ;
            I2C1_Host.Write(0x10,I2C_Wbuffer , 3) ;
            while ( I2C1_Host.IsBusy()) ;
                ...
                I2C_Wbuffer[1] = 0x00 ;
                I2C_Wbuffer[2] = 0x04 ;
                I2C1_Host.Write(0x1f,I2C_Wbuffer,2);
                while ( I2C1_Host.IsBusy()) ;

                I2C_Wbuffer[0] = 0x02 ;
                I2C_Wbuffer[1] = 0x05 ;
                I2C_Wbuffer[2] = 0xa0 ;
                I2C1_Host.Write(0x1f,I2C_Wbuffer,3);
                while ( I2C1_Host.IsBusy()) ;
                ...
                I2C_Wbuffer[0] = 0x1b ;
                I2C_Wbuffer[1] = 0x80 ;
                I2C1_Host.Write(0x0e,I2C_Wbuffer,2);
                while ( I2C1_Host.IsBusy()) ;
    ...
    while(1)
    {
        ...
        if (PORTAbits.RA1 && PORTAbits.RA2 && PORTBbits.RB3 && PORTAbits.RA5 && PORTBbits.RB5)
        {
            if (SW_Detected == 1)
            {
                ...
                do { LATFbits.LATF5 = ~LATFbits.LATF5; } while(0) ;
            }
        ...
        if (!PORTDbits.RD0 && (SW3_Released == 1))
        {
            SW3_Released = 0;
        ...
        if (PORTDbits.RD0 && (SW3_Released == 0))
                SW3_Released = 1 ;
...
void Mode1_Update(void)
{
                ...
                I2C_Wbuffer[0] = 5 ;
                I2C1_Host.WriteRead(0x1f,I2C_Wbuffer,1,I2C_Rbuffer,2);
                while ( I2C1_Host.IsBusy()) ;
                ...
                I2C_Wbuffer[0] = 4 ;
                I2C1_Host.WriteRead(0x10,I2C_Wbuffer,1,I2C_Rbuffer,2);
                while ( I2C1_Host.IsBusy()) ;
...
void Mode2_Update(void)
{
                ...
                I2C_Wbuffer[0] = 0x6 ;
                I2C1_Host.WriteRead(0x0e,I2C_Wbuffer,1,I2C_Rbuffer,6);
                while ( I2C1_Host.IsBusy()) ;
...
void WeatherStation_initialize(void)
{
    ...
    BME280_config(0x00, 0x00);





    BME280_ctrl_meas(0x01, 0x01, 0x03);
