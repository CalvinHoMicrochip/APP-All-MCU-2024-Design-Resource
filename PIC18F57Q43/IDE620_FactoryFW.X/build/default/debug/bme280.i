...
void BME280_reset(void) {
    ...
    I2C_Wbuffer[0] = 0xE0 ;
    I2C_Wbuffer[1] = 0xB6 ;
    I2C1_Host.Write(0x76,I2C_Wbuffer , 2) ;
    while (I2C1_Host.IsBusy()) ;
}

void BME280_sleep(void) {
    bme280_ctrl_meas.mode = 0x00;
...
void BME280_readFactoryCalibrationParams(void) {
    ...
    I2C_Wbuffer[0] = 0x88 ;
    I2C1_Host.WriteRead(0x76,I2C_Wbuffer,1, paramBuff, 24);
    while (I2C1_Host.IsBusy()) ;
    ...
    I2C_Wbuffer[0] = 0xA1 ;
    I2C1_Host.WriteRead(0x76,I2C_Wbuffer,1, paramBuff, 1);
    while (I2C1_Host.IsBusy()) ;
    ...
    I2C_Wbuffer[0] = 0xE1 ;
    I2C1_Host.WriteRead(0x76,I2C_Wbuffer,1, paramBuff, 7);
    while (I2C1_Host.IsBusy()) ;
...
void BME280_readMeasurements(void) {
    ...
    I2C_Wbuffer[0] = 0xF7 ;
    I2C1_Host.WriteRead(0x76,I2C_Wbuffer,1, sensorData, 8);
    while (I2C1_Host.IsBusy()) ;
    adc_H = ((uint32_t) sensorData[6] << 8) |
            sensorData[7];

    adc_T = ((uint32_t) sensorData[3] << 12) |
            (((uint32_t) sensorData[4] << 4) |
            ((uint32_t) sensorData[5] >> 4));

    adc_P = ((uint32_t) sensorData[0] << 12) |
            (((uint32_t) sensorData[1] << 4) |
            ((uint32_t) sensorData[2] >> 4));
}
